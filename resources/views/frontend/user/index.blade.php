  ...
  <div id="tabs" class="tabs">
    <nav>
      <ul>
        ...
        <li <?php if(session('statusProfile') || session('ok') == true) echo 'class="tab-current"';?>><a href="#section-4" class="icon-profile"><span>@lang('frontend.userProfile')</span></a>
        </li>
      </ul>
    </nav>
    <div class="content">

      <section id="section-1" @if(!session('statusProfile') || !session('ok') == true) class="content-current" @endif>
        <div id="tools">
          <div class="row">
      ...
      <section id="section-4"@if(session('statusProfile') || session('ok') == true) class="content-current" @endif>
        <div class="row">
          <div class="col-md-6">
          ...
          <div class="col-md-6">
            <p>
            <img src="{{ $user->photo == null ? url('frontend/img/tourist_guide_pic.jpg') : url('storage/'.$user->photo) }}" alt="Image" class="img-fluid styled profile_pic">
            </p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="fName" id="first_name" type="text" value="{{ old('fName') ?? $user->fName }}">
            </div>
            {{ $errors->first('fName') }}
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="lName" id="last_name" type="text" value="{{ old('lName') ?? $user->lName }}">
            </div>
            {{ $errors->first('lName') }}
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="street" id="first_name" type="text" value="{{ old('street') ?? $user->street }}">
            </div>
            {{ $errors->first('street') }}
          </div>
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control" name="city" id="last_name" type="text" value="{{ old('city') ?? $user->city }}">
            </div>
            {{ $errors->first('city') }}
          </div>
        </div>
